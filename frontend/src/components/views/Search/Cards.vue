<template>
      ...
      <div class="row p-2">
        ...
        <div class="col-sm-6 p-2 content-section">
          ...
          <div class="rating p-2">
            <div class="stars">
              <img v-for="star in stars" :key="star" :src="star" alt="Star" class="star" />
            </div>
  ...
  .col-sm-3 {
    width: 30%; /* Hình ảnh và nút trái tim chiếm 30% chiều rộng */
  }
  ...
  .col-sm-3 p-2 {
    width: 10%; /* Phần trái tim chiếm 10% chiều rộng */
  }
  </style>
