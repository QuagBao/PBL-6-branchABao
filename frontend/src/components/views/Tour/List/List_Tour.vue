...
.frame-list {
    ...
    display: grid;
    grid-template-columns: 25% 70%; /* Chỉnh lại tỷ lệ cột để hài hòa hơn */
...
.frame-list-items {
    display: grid;
    grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); /* Đảm bảo responsive */
    gap: 40px; /* Giảm khoảng cách giữa các item */
