    ...
    <div class="container-fluid p-5 frame-overall">
        <div class="container-fluid overall">
            <div class="container-fluid p-5 top-rating d-flex justify-content-center align-items-baseline">
                ...
                <button class="btn-add d-flex justify-content-around align-items-center" @click="navigateToAddTour">
                    <svg fill="#EDF6F9" width="20px" height="20px" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512">
                        <path
                    ...
                    <tr v-for="(tour, index) in paginatedList" :key="index">
                        ...
                        <td class="view">
                            <button class="btn-view" @click="navigateToDetailTour(tour.id)">
                                <svg fill="currentColor" width="22px" height="22px" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 576 512">
                                    <path
