        ...
        <div class="container-fluid overall">
            <div class="container-fluid d-flex flex-column gap-5">
                ...
                <div class="frame-input">
                        ...
                        <div class="container-fluid">
                            <div class="custom form-floating mt-3">
                                <input type="text" class="form-control" id="tourName" placeholder="Tour Name"
                                    name="tourName" v-model="tourName">
                    ...
                    <div class="container-fluid">
                        <div class="description custom form-floating mt-3">
                            <textarea type="text" class="form-control description" id="tourName" placeholder="Tour Name"
                                name="tourName" v-model="description" />
                ...
                <div class="container-fluid frame-dest-list d-flex flex-column gap-3">
                    <div>
                        <button class="btn-add d-flex justify-content-around align-items-center" type="button"
                            data-bs-toggle="modal" data-bs-target="#listDestination">
                        ...
                        <List_Destination :destList="destinations_2" @addDestination="handleAddDestination" />
                    </div>
                    <table class="table table-responsive table-striped">
                        ...
                        <tbody>
                            <tr v-for="(destination, index) in paginatedList" :key="index">
                                ...
                                <td class="remove">
                                    <button class="btn-delete" @click="removeDestination(destination.id)">
                    ...
                    <div class="pagination-container d-flex justify-content-center align-items-center mt-3">
                        ...
                        <button v-for="page in totalPages" :key="page" class="btn-pagination"
                ...
                <div class=" d-flex justify-content-between">
                    <button class="container-fluid button cancel" type="button" @click="navigateListTour">
                        Cancel
                    </button>
                    <button class="container-fluid button submit" type="button" @click="SendAddTour">
                        Submit
                    </button>
                </div>
            </div>
