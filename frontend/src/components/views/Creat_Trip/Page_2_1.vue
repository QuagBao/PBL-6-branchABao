        ...
        <div class="container-fluid p-2">
            ...
            <div class="container-fluid frame-choose-length">
                ...
                <div class="container-fluid length">
                    <div class="button-1">
                        <svg width="30px" height="30px" @click="decreaseLength" 
                             :class="{disabled: numberLength <= 1}" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
                    ...
                    <div class="button-1">
                        <svg width="30px" height="30px" @click="increaseLength" 
                             :class="{disabled: numberLength >= 7}" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
                            <title>plus-circle</title>
                            <desc>Created with Sketch Beta.</desc>
                            <defs></defs>
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                                <g id="Icon-Set" sketch:type="MSLayerGroup" transform="translate(-464.000000, -1087.000000)" fill="#currentColor">
