    ...
    <div class="container-fluid header p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <div class="navbar-brand p-0">
                <h1 class="m-0"><img src="@/assets/images/company_image.png" alt="Logo" class="logo" />Travel Trips</h1>
            </div>
            ...
            <div class="collapse navbar-collapse text-lg-end" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <button class="nav-item nav-link">Tour Proposal</button>
                    <div class="nav-item dropdown">
                        <button class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Trips</button>
                        <div class="dropdown-menu m-0">
                            <button class="dropdown-item">My Trips</button>
                            <button class="dropdown-item">Start a new trip</button>
                            <button class="dropdown-item">Create a new trip by AI</button>
                        </div>
                    </div>
                    <button class="nav-item nav-link">Travel Itinerary</button>
                    <button class="nav-item nav-link">Forum</button>
                    <div class="nav-item dropdown">
