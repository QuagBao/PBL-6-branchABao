  ...
  <div class="restaurant-management">
    ...
    <div v-if="actionStep === 'update'" class="form-container">
      ...
      <form @submit.prevent="submitUpdateRestaurant" class="form-style">
        ...
        <div class="form-group">
          <label>Description:</label>
          <input type="text" v-model="currentRestaurant.description" />
        </div>
        <div class="form-group">
          <label>Price bottom:</label>
          <input type="number" v-model="currentRestaurant.price_bottom" />
        </div>
        <div class="form-group">
          <label>Price top:</label>
          <input type="number" v-model="currentRestaurant.price_top" />
        </div>
        <div class="form-group">
          <label>Age:</label>
          <input type="number" v-model="currentRestaurant.age" />
        </div>
        <div class="form-group">
          <label>Open time:</label>
          <input type="time" v-model="currentRestaurant.opentime" />
        </div>
        <div class="form-group">
          <label>Duration:</label>
          <input type="number" v-model="currentRestaurant.duration" />
        </div>
        <div class="form-group">
          <label>Date Create:</label>
          <input type="date" v-model="currentRestaurant.date_create" />
        </div>
        <div class="form-group">
          <label>City:</label>
          <select
            v-model="currentRestaurant.address.city_id"
            class="form-control"
          >
            <option v-for="city in cities" :key="city.id" :value="city.id">
              {{ city.name }}
        ...
        <div class="form-group">
          <label>District:</label>
          <input type="text" v-model="currentRestaurant.address.district" />
        </div>
        <div class="form-group">
          <label>Ward:</label>
          <input type="text" v-model="currentRestaurant.address.ward" />
        </div>
        <div class="form-group">
          <label>Street:</label>
          <input type="text" v-model="currentRestaurant.address.street" />
        </div>
        ...
        <div class="form-group">
          ...
          <div class="image-list">
            <div
              v-for="img in currentRestaurant.images"
              :key="img.id"
              class="image-item"
            >
...
export default {
  setup() {
    ...
    const submitAddRestaurant = async () => {
      await confirmCreate(restaurant.value, destination.value, images.value);
    ...
    const removeExistingImage = (id) => {
      ...
      currentRestaurant.value.images = currentRestaurant.value.images.filter(
        (img) => img.id !== id
      );
    };
